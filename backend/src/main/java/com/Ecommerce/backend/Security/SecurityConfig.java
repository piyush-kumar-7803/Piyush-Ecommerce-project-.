...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Let CORS preflight requests through before any auth rule runs
                        .requestMatchers(org.springframework.http.HttpMethod.OPTIONS, "/**").permitAll()

                        // Authentication APIs - no JWT required
                        .requestMatchers("/api/auth/**").permitAll()

                        // Browsing products/categories is public; images are public
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/products/**").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/categories/**").permitAll()
                        .requestMatchers("/images/**").permitAll()

                        // Only admins can create/edit/delete products or categories
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of(
                "http://localhost:5173",
                "https://piyush-ecommerce-project-m1j96eays-piyush-5814.vercel.app"
        ));
